...
typedef enum
{
  LED_1 = 0,  // Green Led on STM32F4-Discovery
  LED_2 = 1, // Orange Led on STM32F4-Discovery
  LED_3 = 2,    // Red Led on STM32F4-Discovery
//  LED_4 = 3    // Blue Led on STM32F4-Discovery
}LED_NAME;

#define  TOTAL_LED   3 // Anzahl von LED_NAME_t
